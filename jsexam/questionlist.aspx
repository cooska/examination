...
<div class="Edit_paner">
  ...
  <div class="flt QuseTitle" style="font-size:18px;">试题类型:</div>
   ...
   <div class="flt QuseTitle" style="margin-left:10px;font-size:18px;">模块类型:</div>
    <select id="up_ctr_module" class="flt" style="height:24px;font-size:14px;margin-top:4px; margin-left:4px;margin-right:4px;" onchange="setkng3(this);">
      <option value="-1">- 请选择 -</option>
       <%for (int i = 0; i < ModuleList.Rows.Count; i++)
       {%>
    ...
    <div class="flt QuseTitle" style="margin-left:10px;font-size:18px;">知识点:</div>
    <select id="up_kng_id" class="flt" style="width:258px; height:24px;font-size:14px;margin-top:4px; margin-left:4px;margin-right:4px;">
      <option value="-1">- 请选择 -</option>
   </select>
</div>
<div class="cb"></div>
<div class="QuseTitle" style="font-size:18px;">试题题干</div>
